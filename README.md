...
Easily convert the [KITTI dataset](http://www.cvlibs.net/datasets/kitti/index.php) into a ROS bag file!

This tool is a fork of the original [kitti2bag repository](https://github.com/tomas789/kitti2bag.git), with added compatibility for odometry laser data sequences. Full credit goes to the original creator, and contributions to the main functionality should be directed to the main repository.
...
```sh
git clone https://github.com/Thorfr123/kitti2bag.git
cd kitti2bag
sudo pip install .
```
...
$ kitti2bag raw_sync -t 2011_09_26 -r 0002
